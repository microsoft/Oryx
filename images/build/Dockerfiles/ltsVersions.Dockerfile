...
ENV ORYX_PATHS="/opt/oryx:/opt/golang/lts/go/bin:/opt/nodejs/lts/bin:/opt/dotnet/lts:/opt/python/latest/bin:/opt/php/lts/bin:/opt/php-composer:/opt/yarn/stable/bin:/opt/hugo/lts"
