...
echo
createLinks "$FINAL_STRETCH_DOT_NET_CORE_30_SDK_VERSION" "$FINAL_STRETCH_NET_CORE_APP_30"
echo
createLinks "$FINAL_STRETCH_DOT_NET_CORE_22_SDK_VERSION" "$FINAL_STRETCH_NET_CORE_APP_22"
echo
createLinks "$FINAL_STRETCH_DOT_NET_CORE_21_SDK_VERSION" "$FINAL_STRETCH_NET_CORE_APP_21"