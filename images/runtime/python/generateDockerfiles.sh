...
declare -r PYTHON_BUSTER_VERSION_ARRAY=($PYTHON310_VERSION $PYTHON39_VERSION $PYTHON38_VERSION)
declare -r PYTHON_STRETCH_VERSION_ARRAY=($PYTHON27_VERSION $PYTHON36_VERSION $PYTHON37_VERSION)
ImageDebianFlavor="$1"
