...
declare -r PYTHON_BUSTER_VERSION_ARRAY=($PYTHON39_VERSION $PYTHON310_VERSION)
...
do
	...
	PYTHON_IMAGE_NAME="python-$MAJOR_MINOR_VERSION"
	echo "Generating Dockerfile for image '$PYTHON_IMAGE_NAME' in directory '$MAJOR_MINOR_VERSION'..."
	...
	sed -i "s|$ORYX_IMAGE_TAG_PLACEHOLDER|$PYTHON_IMAGE_NAME|g" "$TARGET_DOCKERFILE"
