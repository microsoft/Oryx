...
declare -r PYTHON_BULLSEYE_VERSION_ARRAY=($PYTHON37_VERSION $PYTHON310_VERSION)
declare -r PYTHON_BUSTER_VERSION_ARRAY=($PYTHON39_VERSION)
declare -r PYTHON_STRETCH_VERSION_ARRAY=($PYTHON27_VERSION $PYTHON36_VERSION $PYTHON38_VERSION)
ImageDebianFlavor="$1"
