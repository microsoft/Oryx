...
do
	...
	PHP_IMAGE_NAME="php-$VERSION_DIRECTORY-$ImageDebianFlavor"
	...
	RUNTIME_BASE_IMAGE_NAME="mcr.microsoft.com/oryx/base:php-$VERSION_DIRECTORY-$ImageDebianFlavor-$PHP_RUNTIME_BASE_TAG"
