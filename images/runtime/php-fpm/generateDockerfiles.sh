...
do
	...
	# RUNTIME_BASE_IMAGE_NAME="php-fpm-$VERSION_DIRECTORY-$PHP_RUNTIME_BASE_TAG"
    RUNTIME_BASE_IMAGE_NAME="mcr.microsoft.com/oryx/base:php-fpm-$VERSION_DIRECTORY-$PHP_RUNTIME_BASE_TAG"
