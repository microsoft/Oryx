...
do
	...
	PHP_IMAGE_NAME="php-fpm-$VERSION_DIRECTORY-$ImageDebianFlavor"
    ...
    RUNTIME_BASE_IMAGE_NAME="mcr.microsoft.com/oryx/base:php-$VERSION_DIRECTORY-fpm-$ImageDebianFlavor-$PHP_FPM_RUNTIME_BASE_TAG"
