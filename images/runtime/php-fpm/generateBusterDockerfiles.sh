...
declare -r DOCKERFILE_TEMPLATE="$DIR/template.Buster.Dockerfile"
declare -r DOCKERFILE_BASE_TEMPLATE="$DIR/template.base.Buster.Dockerfile"
...
do
	...
	TARGET_DOCKERFILE_BASE="$DIR/$VERSION_DIRECTORY/base.buster.Dockerfile"
	...
	# RUNTIME_BASE_IMAGE_NAME="php-$VERSION_DIRECTORY-fpm-$PHP_FPM_RUNTIME_BASE_TAG-buster"
    RUNTIME_BASE_IMAGE_NAME="mcr.microsoft.com/oryx/base:php-$VERSION_DIRECTORY-fpm-$PHP_FPM_RUNTIME_BASE_TAG-buster"
