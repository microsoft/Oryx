...
ENV NET_CORE_APP_80_SHA ${NET_CORE_APP_80_SHA}
ARG ASPNET_CORE_APP_80_SHA
ENV ASPNET_CORE_APP_80_SHA ${ASPNET_CORE_APP_80_SHA}
ARG NET_CORE_APP_80
ENV NET_CORE_APP_80 ${NET_CORE_APP_80}
ARG ASPNET_CORE_APP_80
ENV ASPNET_CORE_APP_80 ${ASPNET_CORE_APP_80}
