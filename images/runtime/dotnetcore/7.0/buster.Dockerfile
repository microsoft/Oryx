...
ENV NET_CORE_APP_70_SHA ${NET_CORE_APP_70_SHA}
ARG ASPNET_CORE_APP_70_SHA
ENV ASPNET_CORE_APP_70_SHA ${ASPNET_CORE_APP_70_SHA}
ARG NET_CORE_APP_70
ENV NET_CORE_APP_70 ${NET_CORE_APP_70}
ARG ASPNET_CORE_APP_70
ENV ASPNET_CORE_APP_70 ${ASPNET_CORE_APP_70}
