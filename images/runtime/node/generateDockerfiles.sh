...
declare -r ALPINE_OR_STRETCH_PLACEHOLDER="%NODE_BASE_IMAGE_ALPINE_OR_STRETCH%"
...
do
	...
	if [[ $NODE_IMAGE_NAME == *"alpine"* ]]; then
	...
	sed -i "s|$IMAGE_NAME_PLACEHOLDER|$NODE_IMAGE_NAME|g" "$TARGET_DOCKERFILE"
