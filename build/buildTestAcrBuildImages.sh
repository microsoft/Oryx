...
declare -r supportFilesImageName="oryxtestmcr.azurecr.io/private/oryx/support-files-image-for-build"
...
function buildGitHubRunnersUbuntuBaseImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/githubrunners-buildpackdeps-focal" \
...
function buildGitHubRunnersBullseyeBaseImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/githubrunners-buildpackdeps-bullseye" \
...
function buildGitHubRunnersBusterBaseImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/githubrunners-buildpackdeps-buster" \
...
function buildGitHubRunnersBaseImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/githubrunners-buildpackdeps-stretch" \
...
function buildTemporaryFilesImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/support-files-image-for-build" \
...
function buildBuildScriptGeneratorImage() {
	...
	docker build -t "oryxtestmcr.azurecr.io/private/oryx/buildscriptgenerator" \
