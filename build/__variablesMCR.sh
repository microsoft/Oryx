...
declare -r DOCKER_BUILD_IMAGES_REPO="oryxdevmcr.azurecr.io/internal/oryx/build-image"
declare -r DOCKER_RUNTIME_IMAGES_REPO="oryxdevmcr.azurecr.io/internal/oryx/runtime"
