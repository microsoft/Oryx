...
declare -r BUILD_IMAGES_BUILD_AND_RUN_DOCKERFILE="$REPO_DIR/images/build/Dockerfiles/buildAndRun.Dockerfile"
...
declare -r ACR_BUILD_AND_RUN_IMAGE_REPO="$ACR_DEV_NAME/public/oryx/build-and-run"
