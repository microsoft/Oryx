...
declare -r DOCKER_PACK_STACK_BASE_IMAGE_NAME="pack-stack-base"
declare -r DOCKER_PACK_STACK_BASE_IMAGE_REPO="$DOCKER_DEV_REPO_BASE/$DOCKER_PACK_STACK_BASE_IMAGE_NAME"
declare -r DOCKER_PACK_BUILDER_IMAGE_NAME="pack-builder"
declare -r DOCKER_PACK_BUILDER_IMAGE_REPO="$DOCKER_DEV_REPO_BASE/$DOCKER_PACK_BUILDER_IMAGE_NAME"
