...
declare -r BUILD_IMAGES_CLI_MARINER_DOCKERFILE="$REPO_DIR/images/build/Dockerfiles/cli-mariner.Dockerfile"
declare -r BUILD_IMAGES_NODE_MARINER_DOCKERFILE="$REPO_DIR/images/build/Dockerfiles/node-mariner.Dockerfile"
...
declare -r RUNTIME_MARINER_BASE_IMAGE_DOCKERFILE_PATH="$RUNTIME_IMAGES_SRC_DIR/commonbase/marinerBase.Dockerfile"
