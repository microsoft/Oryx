...
declare -r DOCKER_PACK_STACK_BASE_IMAGE_REPO="$DOCKER_DEV_REPO_BASE/pack-stack-base"
declare -r DOCKER_PACK_BUILDER_IMAGE_REPO="mcr.microsoft.com/oryx/pack-builder"
