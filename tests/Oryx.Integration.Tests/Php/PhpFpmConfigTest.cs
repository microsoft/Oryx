...
namespace Microsoft.Oryx.Integration.Tests
{
    public class PhpFpmConfigTest : PhpEndToEndTestsBase
    {
        ...
        public async Task PipelineTestInvocationsPhp80()
        {
            ...
            await PhpFpmConfigTestAsync(phpVersion80);
        }
        ...
        public async Task PipelineTestInvocationsPhp74()
        {
            ...
            await PhpFpmConfigTestAsync(phpVersion74);
        }

        [Theory]
        [InlineData("8.0")]
        [InlineData("7.4")]
        public async Task PhpFpmConfigTestAsync(string phpVersion)
        {
            // Arrange
            ...
            var runScript = new ShellScriptBuilder()
                ...
                .AddCommand($"cat /usr/local/etc/php-fpm.d/www.conf")
                .ToString();
            ...
            await EndToEndTestHelper.BuildRunAndAssertAppAsync(
                ...
                async (hostPort) =>
                {
                    ...
                    Assert.Contains("pm.max_children = 5", output);
                });
        }
    }
}