...
namespace Microsoft.Oryx.Integration.Tests
{
    public class PhpTwigExampleTest : PhpEndToEndTestsBase
    {
        ...
        public async Task PipelineTestInvocationsPhp83Async()
        {
            ...
            await Task.WhenAll(
                TwigExampleAsync(phpVersion83, ImageTestHelperConstants.OsTypeDebianBullseye),
                PhpFpmTwigExampleAsync(phpVersion83, ImageTestHelperConstants.OsTypeDebianBullseye));
        }
