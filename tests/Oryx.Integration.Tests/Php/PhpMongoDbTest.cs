...
{
    [Trait("category", "php")]
    public class PhpMongoDbTest : PhpEndToEndTestsBase
    {
        public PhpMongoDbTest(ITestOutputHelper output, TestTempDirTestFixture fixture)
            : base(output, fixture)
        {
        }
        ...
        [InlineData("7.0")]
        [InlineData("5.6")]
        public async Task MongoDbExample(string phpVersion)
        {
            // Arrange
            var appName = "mongodb-example";
