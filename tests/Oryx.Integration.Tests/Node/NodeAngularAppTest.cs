...
namespace Microsoft.Oryx.Integration.Tests
{
    public class NodeAngularAppTest : NodeEndToEndTestsBase
    {
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRun_Angular14App_With_NodeModule_Dir_Exists_InRoot_WithoutCompression(string nodeVersion)
        {
            // Arrange
            var appName = "angular14app";
            var volume = CreateAppVolume(appName);
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRun_Angular14App_With_NodeModule_Dir_Exists_InAppDir_WithoutCompression(string nodeVersion)
        {
            // Arrange
            var appName = "angular14app";
            var volume = CreateAppVolume(appName);
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRun_Angular14App_With_NodeModule_SymLink_Exists_InRoot_WithoutCompression(string nodeVersion)
        {
            // Arrange
            var appName = "angular14app";
            var volume = CreateAppVolume(appName);
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRun_Angular14App_With_NodeModule_SymLink_Exists_InAppDir_WithoutCompression(string nodeVersion)
        {
            // Arrange
            var appName = "angular14app";
            var volume = CreateAppVolume(appName);
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRunAngular14_WithDevAndProdDependencies_NodeModule_Dir_Exists_InAppDir_UsingCompression(string nodeVersion)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("16"), Trait("category", "node-16")]
        public async Task CanBuildAndRunAngular14_WithDevAndProdDependencies_NodeModule_SymLink_Exists_InRootDir_UsingCompression(string nodeVersion)
        {
            // Arrange
            string compressFormat = "tar-gz";
            var appOutputDirVolume = CreateAppOutputDirVolume();
