...
namespace Microsoft.Oryx.RuntimeImage.Tests
{
    public class NodeRuntimeImageRunAppUsingConfigYml : NodeRuntimeImageTestBase
    {
        ...
        public async Task RunBullseyeNodeAppUsingConfigYmlAsync(string nodeVersion, string osType)
        {
        ...
        [MemberData(nameof(TestValueGenerator.GetBookwormNodeVersions_SupportPm2), MemberType = typeof(TestValueGenerator))]
        public async Task RunBookwormNodeAppUsingConfigYmlAsync(string nodeVersion, string osType)
        {
