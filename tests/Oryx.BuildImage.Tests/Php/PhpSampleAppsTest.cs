...
namespace Microsoft.Oryx.BuildImage.Tests
{
    public class PhpSampleAppsTest : SampleAppsTestBase
    {
        ...
        [InlineData(FinalStretchVersions.FinalStretchPhp74Version, ImageTestHelperConstants.CliRepository)]
        [InlineData(FinalStretchVersions.FinalStretchPhp73Version, ImageTestHelperConstants.CliRepository)]
