...
namespace Microsoft.Oryx.BuildImage.Tests
{
    public class PythonDynamicInstallationTest : PythonSampleAppsTestBase
    {
        ...
        [Fact, Trait("category", "cli-builder-buster")]
        public void PipelineTestInvocationCliBuilderBuster()
        {
            var imageTestHelper = new ImageTestHelper();
            GeneratesScript_AndBuildsPython_FlaskApp(
                imageTestHelper.GetCliBuilderImage(ImageTestHelperConstants.CliBuilderBusterTag), PythonVersions.Python39Version, "/opt");
            GeneratesScript_AndBuildsPython_FlaskApp(
                imageTestHelper.GetCliBuilderImage(ImageTestHelperConstants.CliBuilderBusterTag), PythonVersions.Python310Version, "/opt");
        }
