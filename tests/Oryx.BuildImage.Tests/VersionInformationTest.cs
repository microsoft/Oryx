...
namespace Microsoft.Oryx.BuildImage.Tests
{
    public class VersionInformationTest
    {
        ...
        [InlineData(NodeVersions.Node6Version, "v" + NodeVersions.Node12Version)]
        [InlineData(NodeVersions.Node8Version, "v" + NodeVersions.Node12Version)]
        [InlineData(NodeVersions.Node10Version, "v" + NodeVersions.Node12Version)]
