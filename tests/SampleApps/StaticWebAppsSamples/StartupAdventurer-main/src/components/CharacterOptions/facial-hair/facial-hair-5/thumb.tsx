...
const FacialHair5Thumb = ({ colors = defaultColor }: IProps = {}) => {
	const [color1, color2, color3] = colors;
	return (
		<svg version="1.1" id="facial_hair_5" x="0px" y="0px" viewBox="0 0 182 182">
			<path
			...
			<g fill={color1}>
				<path d="m151.7 141.6v10.1h-10.1v-10.1-10.2h10.1z" />
				<path d="m141.6 151.7v10.1h-10.2-10.1-10.1-10.1-10.1-10.1v-10.1h10.1v-10.1h10.1 10.1 10.1 10.1v10.1z" />
				<path d="m80.9 141.6v10.1h-10.1v-10.1-10.2h10.1z" />
			</g>
			<path d="m111.2 151.7v-10.1h-10.1-10.1v10.1h-10.1v10.1h10.1 10.1 10.1 10.1v-10.1z" fill={color3} />
			<path d="m80.9 131.4h-10.1v10.2 10.1h10.1v-10.1z" fill={color3} />
			<path d="m121.3 151.7h10.1v-10.1h-10.1-10.1v10.1z" fill={color2} />
		</svg>
	);
};

export default FacialHair5Thumb;
