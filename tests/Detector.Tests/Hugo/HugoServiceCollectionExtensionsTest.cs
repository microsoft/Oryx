...
{
    public class HugoServiceCollectionExtensionsTest
    {
        [Fact]
        public void ReturnsSameInstanceOfDetectorWhenResolvedAsIHugoPlatformDetector()
        {
            // Arrange
            ...
            // Act
            var instance1 = serviceProvider.GetRequiredService<IHugoPlatformDetector>();
            var instance2 = serviceProvider.GetRequiredService<IHugoPlatformDetector>();
