...
{
    public class PhpServiceCollectionExtensionsTest
    {
        [Fact]
        public void ReturnsSameInstanceOfDetectorWhenResolvedAsIPhpPlatformDetector()
        {
            // Arrange
            ...
            // Act
            var instance1 = serviceProvider.GetRequiredService<IPhpPlatformDetector>();
            var instance2 = serviceProvider.GetRequiredService<IPhpPlatformDetector>();
