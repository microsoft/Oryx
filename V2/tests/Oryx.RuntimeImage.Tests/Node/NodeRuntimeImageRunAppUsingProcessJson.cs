...
namespace Microsoft.Oryx.RuntimeImage.Tests
{
    public class NodeRuntimeImageRunAppUsingProcessJson : NodeRuntimeImageTestBase
    {
        ...
        public async Task RunBullseyeNodeAppUsingProcessJson(string nodeVersion, string osType)
        {
        ...
        public async Task RunBookwormNodeAppUsingProcessJson(string nodeVersion, string osType)
        {
