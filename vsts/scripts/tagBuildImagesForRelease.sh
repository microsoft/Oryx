...
tagBuildImage "oryxdevmcr.azurecr.io/public/oryx/build:vso-ubuntu-focal-$BUILD_DEFINITIONNAME.$RELEASE_TAG_NAME" "vso-ubuntu-bullseye" "vso-ubuntu-bullseye-$RELEASE_TAG_NAME"
