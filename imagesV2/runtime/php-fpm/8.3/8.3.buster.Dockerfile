...
COPY imagesV2/runtime/php-fpm/8.3/docker-php-source /usr/local/bin/
...
COPY imagesV2/runtime/php-fpm/8.3/docker-php-ext-* imagesV2/runtime/php-fpm/8.3/docker-php-entrypoint /usr/local/bin/
...
RUN ls -l /etc/nginx
COPY imagesV2/runtime/php-fpm/nginx_conf/default.conf /etc/nginx/sites-available/default
COPY imagesV2/runtime/php-fpm/nginx_conf/default.conf /etc/nginx/sites-enabled/default
