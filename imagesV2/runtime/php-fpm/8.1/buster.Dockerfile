...
COPY imagesV2/runtime/php-fpm/8.1/docker-php-source /usr/local/bin/
...
COPY imagesV2/runtime/php-fpm/8.1/docker-php-ext-* imagesV2/runtime/php-fpm/8.1/docker-php-entrypoint /usr/local/bin/
