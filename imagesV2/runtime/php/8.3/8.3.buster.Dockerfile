...
COPY imagesV2/runtime/php/8.3/docker-php-source /usr/local/bin/
...
COPY imagesV2/runtime/php/8.3/docker-php-ext-* imagesV2/runtime/php/8.3/docker-php-entrypoint /usr/local/bin/
...
COPY imagesV2/runtime/php/8.3/apache2-foreground /usr/local/bin/
