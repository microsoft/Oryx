...
namespace Microsoft.Oryx.Common
{
    public static class OryxDirectoryStructureHelper
    {
        ...
        public static string GetDirectoryStructure(string sourcePath)
        {
            ...
            {
                var directoryStructureData = GetDirectoryStructureData(new DirectoryInfo(sourcePath), SourceRepoMaximumDepthToLog, 0);
        ...
        private static JToken GetDirectoryStructureData(DirectoryInfo sourceDirPath, int maxDepth, int processedFiles = 0)
        {
