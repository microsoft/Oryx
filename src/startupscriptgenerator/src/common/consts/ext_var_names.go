...
=======
const FpmConfigurationFile string = "/usr/local/etc/php-fpm.d/www.conf"
const FpmMaxChildrenEnvVarName string = "FPM_MAX_CHILDREN"
const FpmStartServersEnvVarName string = "FPM_START_SERVERS"
const FpmMinSpareServersEnvVarName string = "FPM_MIN_SPARE_SERVERS"
const FpmMaxSpareServersEnvVarName string = "FPM_MAX_SPARE_SERVERS"
const FpmMaxChildrenSettingName string = "pm.max_children"
const FpmStartServersSettingName string = "pm.start_servers"
const FpmMinSpareServersSettingName string = "pm.min_spare_servers"
const FpmMaxSpareServersSettingName string = "pm.max_spare_servers"
>>>>>>> main
