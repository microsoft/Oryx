...
namespace Microsoft.Oryx.BuildScriptGenerator.Common
{
    public static class PythonVersions
    {
        ...
        public const string Python39Version = "3.9.23";
        public const string Python310Version = "3.10.18";
        public const string Python311Version = "3.11.13";
        public const string Python312Version = "3.12.11";
        public const string Python313Version = "3.13.5";
