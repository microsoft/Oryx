...
namespace Microsoft.Oryx.BuildScriptGenerator.Common
{
    public static class PythonVersions
    {
        ...
        public const string Python39Version = "3.9.22";
        public const string Python310Version = "3.10.17";
        public const string Python311Version = "3.11.12";
        public const string Python312Version = "3.12.10";
        public const string Python313Version = "3.13.3";
