...
namespace Microsoft.Oryx.BuildScriptGenerator.Common
{
    public static class FinalStretchVersions
    {
        ...
        public const string FinalStretchDotNet70SdkVersion = "7.0.203";
        public const string FinalStretchDotNetCoreApp70RunTimeVersion = "7.0.5";
        public const string FinalStretchAspnetCoreApp70RunTimeVersion = "7.0.5";
        public const string FinalStretchNode14Version = "14.21.3";
        public const string FinalStretchNode16Version = "16.20.0";
    }
}