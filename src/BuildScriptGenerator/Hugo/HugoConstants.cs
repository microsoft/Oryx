...
namespace Microsoft.Oryx.BuildScriptGenerator.Hugo
{
    ...
    {
        public const string Version = "0.76.3";
        ...
        public const string TomlFileName = "config.toml";
        public const string YamlFileName = "config.yaml";
        public const string YmlFileName = "config.yml";
        public const string JsonFileName = "config.json";
