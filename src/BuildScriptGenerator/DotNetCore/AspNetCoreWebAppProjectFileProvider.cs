...
{
    internal class AspNetCoreWebAppProjectFileProvider : IProjectFileProvider
    {
        private readonly ILogger<AspNetCoreWebAppProjectFileProvider> _logger;
        ...
        public AspNetCoreWebAppProjectFileProvider(ILogger<AspNetCoreWebAppProjectFileProvider> logger)
        {
            _logger = logger;
        }
