...
namespace Microsoft.Oryx.BuildScriptGenerator.Python
{
    public static class CondaConstants
    {
        ...
        public const string DefaultPython2Version = "2.7.15";
        public const string DefaultPython2CondaEnvironmentYmlFileTemplateName = "python2.default.envrionment.yml.template";
    }
}