...
namespace Microsoft.Oryx.BuildScriptGeneratorCli
{
    ...
    internal class DetectCommand : CommandBase
    {
        ...
        private string ListFormatResult(IDictionary<IProgrammingPlatform, string> detectedPlatforms)
        {
        ...
        private string JsonFormatResult(IDictionary<IProgrammingPlatform, string> detectedPlatforms)
        {
            ...
            foreach (var detectedPlatform in detectedPlatforms)
            {
                ...
                data["Platform_Name"] = detectedPlatform.Key.Name;
